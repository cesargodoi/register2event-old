...
response.logo = A(
    B("register", SPAN(2, _class="text-warning h4"), "event"),
    _class="navbar-brand col-md-3 col-lg-2 me-0 px-3",
...
response.meta.author = "Cesar Godoi <cesar.godoi@gmail.com>"
...
response.menu = [
    (T("events"), False, URL("events", "list"), []),
    (T("guests"), False, URL("guest", "list"), []),
]
